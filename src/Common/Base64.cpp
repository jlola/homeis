...
std::string Base64::b64encode(const void* data, const size_t len)
{
...
std::string Base64::b64decode(const void* data, const size_t len)
{
    unsigned char* p = (unsigned char*)data;
...
std::string Base64::b64encode(const std::string& str64)
{
