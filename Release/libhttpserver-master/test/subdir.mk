...
CPP_SRCS += \
../libhttpserver-master/test/basic.cpp 

OBJS += \
./libhttpserver-master/test/basic.o 

CPP_DEPS += \
./libhttpserver-master/test/basic.d 


# Each subdirectory must supply rules for building sources it contributes
libhttpserver-master/test/%.o: ../libhttpserver-master/test/%.cpp
	@echo 'Building file: $<'
