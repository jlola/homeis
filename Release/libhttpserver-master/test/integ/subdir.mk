...
CPP_SRCS += \
../libhttpserver-master/test/integ/basic.cpp 

OBJS += \
./libhttpserver-master/test/integ/basic.o 

CPP_DEPS += \
./libhttpserver-master/test/integ/basic.d 


# Each subdirectory must supply rules for building sources it contributes
libhttpserver-master/test/integ/%.o: ../libhttpserver-master/test/integ/%.cpp
	@echo 'Building file: $<'
